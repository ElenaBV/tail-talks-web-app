# Документация front-end (с использованием LESS)
...
В проекте используется LESS для стилизации. Вы можете создавать файлы `.less` для ваших стилей и импортировать их в ваши компоненты React. Для более тонкой настройки можно изменить файл `webpack.config.js`, чтобы включить поддержку LESS.

### Пример использования LESS:

Создайте файл `styles.less`:
...
7. **LESS:**
   - Используйте LESS для стилизации компонентов.
